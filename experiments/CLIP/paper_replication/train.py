...
logs_file = 'multi-media-interaction/experiments/CLIP/paper_replication/logs/logs.txt'
weights_dir = 'multi-media-interaction/experiments/CLIP/paper_replication/weights'
